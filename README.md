...
|-------|-------|------------|
| Month 1 | SQL & Data Foundations | SQL, Excel, Power BI, Basic Statistics |
| Month 2 | Analysis & Python | Python, Pandas, Root Cause Analysis |
| Month 3 | Advanced Manufacturing Metrics & Portfolio | OEE, MTBF, MTTR, Storytelling |
...
## Portfolio Projects
*(This section will grow over the next 12 weeks)*

| Project | Description | Tools | Status |
|---------|-------------|-------|--------|
| Shift Downtime Analysis | Identify which shift has highest unexplained downtime using SQL joins | SQL | 🔜 Planned |
| Defect Pareto Analysis | Identify vital few defects causing 80% of scrap cost | Python, Pandas | 🔜 Planned |
| OEE Dashboard | Interactive dashboard tracking Availability, Performance, Quality | Power BI | 🔜 Planned |
...
*"The goal is not to become a programmer. The goal is to become a manufacturing professional who can speak the language of data."*
